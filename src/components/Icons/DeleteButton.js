...
const DeleteButton = ({onClick, id, parentId}) => {
  ...
  return (
    <div onMouseOver={hoverColorHandler} onMouseLeave={resetColorHandler} className="icon delete" onClick={() => onClick(id, parentId)}>
      <span>
